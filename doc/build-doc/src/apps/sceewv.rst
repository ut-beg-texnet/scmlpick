...
| :file:`etc/defaults/sceewv.cfg`
| :file:`etc/global.cfg`
| :file:`etc/sceewv.cfg`
| :file:`~/.seiscomp/global.cfg`
| :file:`~/.seiscomp/sceewv.cfg`

sceewv inherits `global options <https://docs.gempa.de/seiscomp/current/apps/global.html>`_.



.. confval:: postProcFreq
...
.. confval:: JSONpath
   ...
   Default is ``@DATADIR@/sceewv/events/``.
...
.. confval:: mapboxtoken
   ...
   Default is ``@DATADIR@/sceewv/mapbox_token``.
...
.. confval:: agency
   ...
   Agency name
   Default is ``OVSICORI-UNA``.

.. confval:: fdsnwsclient

   Type: *String*

   Route to fdsnws service
   Default is ``https://earthquake.usgs.gov/``.
...
.. confval:: fpstatus
   ...
   Show FP delay information in the histogram events dashboard
   Default is ``False``.
...
.. confval:: evejsonpath
   ...
   Default is ``@DATADIR@/sceewv/event/``.
...
.. confval:: colors
   ...
   Default is ``[#4D5656,#424949,#4D5656,#424949]``.
...
.. confval:: envalias
   ...
   Route to fdsnws service to query waveforms
   Default is ``sceewvenv``.

.. confval:: eveminmag

   Type: *int*

   Alias of sceewenv module to use in offline mode to compute envelope data
   Default is ``4``.
...
.. confval:: maxdist
   ...
   Maximum distance in km to look for waveforms to compute envelope data
   Default is ``250``.
...
.. confval:: invuri
   ...
   Database URI to query inventory to produce station list used in the envelope data plot
   Default is ``mysql://sysop:sysop@localhost/seiscomp``.
